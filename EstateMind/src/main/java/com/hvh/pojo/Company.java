...
@NamedQueries({
    ...
    @NamedQuery(name = "Company.findByBusinessLicenseNumber", query = "SELECT c FROM Company c WHERE c.businessLicenseNumber = :businessLicenseNumber"),
    ...
    @NamedQuery(name = "Company.findByLogoUrl", query = "SELECT c FROM Company c WHERE c.logoUrl = :logoUrl"),
    @NamedQuery(name = "Company.findByIsVerified", query = "SELECT c FROM Company c WHERE c.isVerified = :isVerified"),
