...
@NamedQueries({
    ...
    @NamedQuery(
            name = "ChatSession.findById",
            query = "SELECT c FROM ChatSession c WHERE c.id = :id"),
    @NamedQuery(
            name = "ChatSession.findByTitle",
            query = "SELECT c FROM ChatSession c WHERE c.title = :title"),
    @NamedQuery(
            name = "ChatSession.findByCreatedAt",
            query = "SELECT c FROM ChatSession c WHERE c.createdAt = :createdAt"),
    @NamedQuery(
            name = "ChatSession.findByUpdatedAt",
            query = "SELECT c FROM ChatSession c WHERE c.updatedAt = :updatedAt")
})
