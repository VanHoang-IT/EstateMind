        ...
        @NamedQueries({
            ...
            @NamedQuery(name = "Property.findByHasGarden", query = "SELECT p FROM Property p WHERE p.hasGarden = :hasGarden"),
            @NamedQuery(name = "Property.findByHasGarage", query = "SELECT p FROM Property p WHERE p.hasGarage = :hasGarage"),
            @NamedQuery(name = "Property.findByHasSwimmingPool", query = "SELECT p FROM Property p WHERE p.hasSwimmingPool = :hasSwimmingPool"),
            @NamedQuery(name = "Property.findByHasAirConditioning", query = "SELECT p FROM Property p WHERE p.hasAirConditioning = :hasAirConditioning")})
        @JsonIgnoreProperties(value = {"favoritesSet", "legalDocumentSet", "historySet","propertyImagesSet","reviewSet"})
