        ...
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          {canVerifyAccount && (
            <Link
              ...
              className="rounded-md border border-red-500 px-3 py-2 text-sm font-semibold text-red-500 transition-colors hover:bg-red-50"
            >
              Xác minh tài khoản
            </Link>
          )}
          ...
          <div className="p-6">
            <div className="flex flex-col gap-5 border-b border-gray-200 pb-6 sm:flex-row sm:items-center">
              {currentUser.avatar ? (
                ...
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-red-500 text-3xl font-bold text-white">
                  {avatarInitial}
                </div>
              )}
            ...
            {editing ? (
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 focus:border-red-500 focus:outline-none"
                    />
                  </div>
              ...
              <>
                <dl className="mt-6 grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-lg border border-gray-200 p-4">
                    <dt className="text-sm text-gray-500">Tên đăng nhập</dt>
                    <dd className="mt-1 font-medium text-gray-900">
                  ...
                  <div className="rounded-lg border border-gray-200 p-4">
                    <dt className="text-sm text-gray-500">Họ</dt>
                    <dd className="mt-1 font-medium text-gray-900">
                  ...
                  <div className="rounded-lg border border-gray-200 p-4">
                    <dt className="text-sm text-gray-500">Tên</dt>
                    <dd className="mt-1 font-medium text-gray-900">
